classdef Body
    properties
        ...
        numTetrahedrons; Tetrahedrons;TetrahedronsCoordinates;
        BoundaryFaces;
    ...
    methods
        function obj = Body(npoints, points, ntetras, tetras)
            ...
            obj.TetrahedronsCoordinates=tetras;
        ...
        function obj = update_mass(obj,disps)
             ...
             tetras = obj.TetrahedronsCoordinates;
             for p=1:obj.numTetrahedrons
                 i = tetras(p,1); j = tetras(p,2); k = tetras(p,3); l = tetras(p,4);
                 obj.Tetrahedrons(p) = obj.Tetrahedrons(p).update_mass(points(:,i), points(:,j), points(:,k), points(:,l)); 
             end        
        end
